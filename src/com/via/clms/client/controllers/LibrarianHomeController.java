...
public class LibrarianHomeController implements Controller {
	...
	private Button btn6ManageUsers;
	...
	public Parent getComponent() {
		...
		userProfileSection.getChildren().addAll(btn5MyProfile, btn6ManageUsers);
