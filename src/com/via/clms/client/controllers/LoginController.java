...
public class LoginController extends ResultController<UserSession> {
	...
	private int[] libraryids = new int[0];
	...
	public Parent getComponent() {
		...
		btn2Help.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent arg0) {
				...
				String outputPath = synchronizedPath + File.separator + "com" + File.separator + "via" + File.separator
						+ "clms" + File.separator + "client" + File.separator + "help" + File.separator
						+ "DemoGuide.pdf";
